...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.easepass-ring-halo{position:absolute!important;inset:4px!important;border-radius:50%!important;background:radial-gradient(circle,rgba(255,255,255,.92) 0%,rgba(255,255,255,.78) 45%,rgba(255,255,255,0) 90%)!important;box-shadow:0 4px 14px rgba(176,48,96,.18),0 2px 6px rgba(0,0,0,.1)!important;pointer-events:none!important;}',
      '.easepass-ring-ripple{position:absolute!important;inset:0!important;border-radius:50%!important;border:3px solid #8C2550!important;opacity:0!important;pointer-events:none!important;}',
      '.easepass-ring-svg{position:absolute!important;top:0!important;left:0!important;width:100%!important;height:100%!important;overflow:visible!important;filter:drop-shadow(0 0 6px rgba(176,48,96,.35))!important;}',
      '.easepass-ring-track{fill:none!important;stroke:rgba(15,20,25,.2)!important;stroke-width:3!important;}',
      '.easepass-ring-progress{fill:none!important;stroke:#B03060!important;stroke-width:5!important;stroke-linecap:round!important;transition:stroke-dashoffset 50ms linear,stroke .1s ease!important;}',
      '.easepass-ring-progress.easepass-complete{stroke:#8C2550!important;}',
      '.easepass-ring-count{position:absolute!important;top:50%!important;left:50%!important;transform:translate(-50%,-50%)!important;font-family:"Lexend",-apple-system,BlinkMacSystemFont,"Helvetica Neue",sans-serif!important;font-weight:800!important;font-size:18px!important;line-height:1!important;color:#B03060!important;text-align:center!important;text-shadow:0 0 6px rgba(255,255,255,.85),0 0 2px rgba(255,255,255,.9)!important;pointer-events:none!important;user-select:none!important;transition:color .1s ease,transform .18s cubic-bezier(.34,1.56,.64,1)!important;}',
      '.easepass-ring-count.easepass-complete{color:#8C2550!important;transform:translate(-50%,-50%) scale(1.15)!important;}',
      ...
      '.easepass-status-engaged{background:rgba(176,48,96,.96)!important;}',
